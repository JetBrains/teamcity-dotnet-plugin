...
class SdkResolverTest {
    ...
    fun resolveData(): Array<Array<out Any?>> {
        return arrayOf(
                ...
                arrayOf(Framework("net5.1"), emptyList<Property>(), "6 5.1"),
                arrayOf(Framework("net5.0"), emptyList<Property>(), "6 5"),

                arrayOf(Framework("netcoreapp3.1"), emptyList<Property>(), "6 5 3.1"),
                arrayOf(Framework("netcoreapp3.0"), emptyList<Property>(), "6 5 3"),
                arrayOf(Framework("netcoreapp2.2"), emptyList<Property>(), "6 5 3 2.2"),
                arrayOf(Framework("netcoreapp2.1"), emptyList<Property>(), "6 5 3 2.2 2.1"),
                arrayOf(Framework("netcoreapp2.0"), emptyList<Property>(), "6 5 3 2"),
                arrayOf(Framework("netcoreapp1.1"), emptyList<Property>(), "6 5 3 2 1.1"),
                arrayOf(Framework("netcoreapp1.0"), emptyList<Property>(), "6 5 3 2 1"),

                arrayOf(Framework("netstandard2.1"), emptyList<Property>(), "6 5 3"),
                arrayOf(Framework("netstandard2.0"), emptyList<Property>(), "4.8 4.7 4.6.2 4.6.1 6 5 3 2"),
                arrayOf(Framework("netstandard1.6"), emptyList<Property>(), "4.8 4.7 4.6.2 4.6.1 6 5 3 2 1"),
                arrayOf(Framework("netstandard1.5"), emptyList<Property>(), "4.8 4.7 4.6.2 4.6.1 6 5 3 2 1"),
                arrayOf(Framework("netstandard1.4"), emptyList<Property>(), "4.8 4.7 4.6.2 4.6.1 6 5 3 2 1"),
                arrayOf(Framework("netstandard1.3"), emptyList<Property>(), "4.8 4.7 4.6 6 5 3 2 1"),
                arrayOf(Framework("netstandard1.2"), emptyList<Property>(), "4.8 4.7 4.6 4.5.2 4.5.1 6 5 3 2 1"),
                arrayOf(Framework("netstandard1.1"), emptyList<Property>(), "4.8 4.7 4.6 4.5 6 5 3 2 1"),
                arrayOf(Framework("netstandard1.0"), emptyList<Property>(), "4.8 4.7 4.6 4.5 6 5 3 2 1"),
