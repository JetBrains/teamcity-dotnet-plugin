...
class SdkResolverTest {
    ...
    fun resolveData(): Array<Array<out Any?>> {
        return arrayOf(
                ...
                arrayOf(Framework("net472"), emptyList<Property>(), listOf(Version(4, 7, 2))),
                arrayOf(Framework("net471"), emptyList<Property>(), listOf(Version(4, 7, 1))),
                arrayOf(Framework("net47"), emptyList<Property>(), listOf(Version(4, 7))),
                arrayOf(Framework("net462"), emptyList<Property>(), listOf(Version(4, 6, 2))),
                arrayOf(Framework("net461"), emptyList<Property>(), listOf(Version(4, 6, 1))),
                arrayOf(Framework("net46"), emptyList<Property>(), listOf(Version(4, 6))),
                arrayOf(Framework("net452"), emptyList<Property>(), listOf(Version(4, 5, 2))),
                arrayOf(Framework("net451"), emptyList<Property>(), listOf(Version(4, 5, 1))),
                arrayOf(Framework("net45"), emptyList<Property>(), listOf(Version(4, 5))),
