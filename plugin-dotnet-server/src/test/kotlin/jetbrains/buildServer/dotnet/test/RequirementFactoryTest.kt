...
class RequirementFactoryTest {
    ...
    fun testData(): Array<Array<out Any?>> {
        return arrayOf(
                ...
                // .NET Framework
                arrayOf("3.5", Requirement("Exists=>DotNetFramework3.5[\\.\\d]*_x[\\d]{2}", null, RequirementType.EXISTS)),
                arrayOf("4.0", Requirement("Exists=>DotNetFramework4.0[\\.\\d]*_x[\\d]{2}", null, RequirementType.EXISTS)),
                arrayOf("4.0.3", Requirement("Exists=>DotNetFramework4.0.3[\\.\\d]*_x[\\d]{2}", null, RequirementType.EXISTS)),
                arrayOf("4.5", Requirement("Exists=>DotNetFramework4.5[\\.\\d]*_x[\\d]{2}", null, RequirementType.EXISTS)),
                arrayOf("4.5.1", Requirement("Exists=>DotNetFramework4.5.1[\\.\\d]*_x[\\d]{2}", null, RequirementType.EXISTS)),
                arrayOf("4.5.2", Requirement("Exists=>DotNetFramework4.5.2[\\.\\d]*_x[\\d]{2}", null, RequirementType.EXISTS)),
                arrayOf("4.6", Requirement("Exists=>DotNetFramework4.6[\\.\\d]*_x[\\d]{2}", null, RequirementType.EXISTS)),
                arrayOf("4.6.1", Requirement("Exists=>DotNetFramework4.6.1[\\.\\d]*_x[\\d]{2}", null, RequirementType.EXISTS)),
                arrayOf("4.6.2", Requirement("Exists=>DotNetFramework4.6.2[\\.\\d]*_x[\\d]{2}", null, RequirementType.EXISTS)),
                arrayOf("4.7", Requirement("Exists=>DotNetFramework4.7[\\.\\d]*_x[\\d]{2}", null, RequirementType.EXISTS)),
                arrayOf("4.7.1", Requirement("Exists=>DotNetFramework4.7.1[\\.\\d]*_x[\\d]{2}", null, RequirementType.EXISTS)),
                arrayOf("4.7.2", Requirement("Exists=>DotNetFramework4.7.2[\\.\\d]*_x[\\d]{2}", null, RequirementType.EXISTS)),
                arrayOf("4.8", Requirement("Exists=>DotNetFramework4.8[\\.\\d]*_x[\\d]{2}", null, RequirementType.EXISTS)),
                arrayOf("4.8.1", Requirement("Exists=>DotNetFramework4.8.1[\\.\\d]*_x[\\d]{2}", null, RequirementType.EXISTS)),
                arrayOf("4.8.2", Requirement("Exists=>DotNetFramework4.8.2[\\.\\d]*_x[\\d]{2}", null, RequirementType.EXISTS)),
                arrayOf("4.8.2", Requirement("Exists=>DotNetFramework4.8.2[\\.\\d]*_x[\\d]{2}", null, RequirementType.EXISTS)),
                arrayOf("4.8.2", Requirement("Exists=>DotNetFramework4.8.2[\\.\\d]*_x[\\d]{2}", null, RequirementType.EXISTS)),
                arrayOf("4.9", Requirement("Exists=>DotNetFramework4.9[\\.\\d]*_x[\\d]{2}", null, RequirementType.EXISTS)),
                arrayOf("4.9.1", Requirement("Exists=>DotNetFramework4.9.1[\\.\\d]*_x[\\d]{2}", null, RequirementType.EXISTS)),
                arrayOf("4.9.2", Requirement("Exists=>DotNetFramework4.9.2[\\.\\d]*_x[\\d]{2}", null, RequirementType.EXISTS))
        )
    }
