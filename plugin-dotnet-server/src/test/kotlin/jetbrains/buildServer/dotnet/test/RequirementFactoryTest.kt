...
class RequirementFactoryTest {
    ...
    fun testData(): Array<Array<out Any?>> {
        return arrayOf(
                ...
                // .NET Framework
                arrayOf("3.5", Requirement("Exists=>DotNetFrameworkTargetingPack3.5_Path", null, RequirementType.EXISTS)),
                arrayOf("4.0", Requirement("Exists=>DotNetFrameworkTargetingPack4.0_Path", null, RequirementType.EXISTS)),
                arrayOf("4.0.3", Requirement("Exists=>DotNetFrameworkTargetingPack4.0.3_Path", null, RequirementType.EXISTS)),
                arrayOf("4.5", Requirement("Exists=>DotNetFrameworkTargetingPack4.5_Path", null, RequirementType.EXISTS)),
                arrayOf("4.5.1", Requirement("Exists=>DotNetFrameworkTargetingPack4.5.1_Path", null, RequirementType.EXISTS)),
                arrayOf("4.5.2", Requirement("Exists=>DotNetFrameworkTargetingPack4.5.2_Path", null, RequirementType.EXISTS)),
                arrayOf("4.6", Requirement("Exists=>DotNetFrameworkTargetingPack4.6_Path", null, RequirementType.EXISTS)),
                arrayOf("4.6.1", Requirement("Exists=>DotNetFrameworkTargetingPack4.6.1_Path", null, RequirementType.EXISTS)),
                arrayOf("4.6.2", Requirement("Exists=>DotNetFrameworkTargetingPack4.6.2_Path", null, RequirementType.EXISTS)),
                arrayOf("4.7", Requirement("Exists=>DotNetFrameworkTargetingPack4.7_Path", null, RequirementType.EXISTS)),
                arrayOf("4.7.1", Requirement("Exists=>DotNetFrameworkTargetingPack4.7.1_Path", null, RequirementType.EXISTS)),
                arrayOf("4.7.2", Requirement("Exists=>DotNetFrameworkTargetingPack4.7.2_Path", null, RequirementType.EXISTS)),
                arrayOf("4.8", Requirement("Exists=>DotNetFrameworkTargetingPack4.8_Path", null, RequirementType.EXISTS)),
                arrayOf("4.8.1", Requirement("Exists=>DotNetFrameworkTargetingPack4.8.1_Path", null, RequirementType.EXISTS)),
