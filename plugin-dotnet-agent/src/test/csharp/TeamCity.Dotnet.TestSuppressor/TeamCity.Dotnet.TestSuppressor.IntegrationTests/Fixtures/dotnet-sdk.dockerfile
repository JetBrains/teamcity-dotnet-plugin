...
RUN dotnet new console; \
    dotnet add package Microsoft.NET.Test.Sdk --version 17.7.2 --no-restore; \
    ...
    dotnet add package xunit --version 2.5.1 --no-restore; \
    dotnet add package xunit.runner.visualstudio --version 2.5.1 --no-restore; \
    dotnet restore
