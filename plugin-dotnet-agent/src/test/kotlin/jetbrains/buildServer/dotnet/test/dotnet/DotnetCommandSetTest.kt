    ...
    fun shouldGetArguments(
        ...
        _ctx.checking(object : Expectations() {
            init {
                ...
                will(returnValue(DotnetToolResolverStub(ToolPlatform.CrossPlatform, File("dotnet"), false)))
                ...
                will(returnValue(DotnetToolResolverStub(ToolPlatform.CrossPlatform, File("dotnet"), true)))
