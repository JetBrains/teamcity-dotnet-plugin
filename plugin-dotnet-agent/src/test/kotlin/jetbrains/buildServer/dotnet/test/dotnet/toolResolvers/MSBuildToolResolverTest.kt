...
import jetbrains.buildServer.dotnet.toolResolvers.MSBuildToolResolver
...
class MSBuildToolResolverTest {
    ...
    fun testData(): Array<Array<out Any?>> {
        return arrayOf(
                ...
                // Docker
                arrayOf(true, OSType.WINDOWS, mapOf(DotnetConstants.PARAM_MSBUILD_VERSION to Tool.MSBuild15WindowsX86.id, "MSBuildTools15.0_x86_Path" to "msbuild15X86"), File(
                    MSBuildToolResolver.MSBuildWindowsTooName), false, null, _msbuildStateWorkflowComposer),
