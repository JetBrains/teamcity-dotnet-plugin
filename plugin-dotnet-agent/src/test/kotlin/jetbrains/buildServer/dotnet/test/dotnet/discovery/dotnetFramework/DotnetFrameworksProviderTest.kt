...
import jetbrains.buildServer.dotnet.discovery.dotnetFramework.DotnetFrameworkValidator
import jetbrains.buildServer.dotnet.discovery.dotnetFramework.DotnetFrameworksWindowsRegistryVisitor
import jetbrains.buildServer.dotnet.Platform
import jetbrains.buildServer.dotnet.discovery.dotnetFramework.DotnetFrameworksProviderImpl
...
class DotnetFrameworksProviderTest {
    ...
    @MockK
    private lateinit var _dotnetFrameworkValidator: DotnetFrameworkValidator
    @MockK
    private lateinit var _visitor1: DotnetFrameworksWindowsRegistryVisitor
    @MockK
    private lateinit var _visitor2: DotnetFrameworksWindowsRegistryVisitor

    private val _key1 = WindowsRegistryKey.create(
    ...
    private val _key2 = WindowsRegistryKey.create(
    ...
    private val _key3 = WindowsRegistryKey.create(
        WindowsRegistryBitness.Bitness64,
        WindowsRegistryHive.LOCAL_MACHINE,
        "SOFTWARE",
        "Microsoft",
