...
class RootDotnetCommandResolver(
    private val _dotnetCommandsResolvers: List<DotnetCommandsResolver>,
) : DotnetCommandResolverBase() {
    override val stage = DotnetCommandsResolvingStage.Initial

    override fun shouldBeApplied(commands: DotnetCommandsStream) = true

    override fun apply(commands: DotnetCommandsStream) =
        _dotnetCommandsResolvers
